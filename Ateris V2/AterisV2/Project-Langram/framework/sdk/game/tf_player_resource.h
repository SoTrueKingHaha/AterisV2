...
public:
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_iPing");
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_iScore");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_iDeaths");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	bool GetConnected(int idx)
	{
		...
		static auto offset = N::FindNetvar("CPlayerResource", "m_bConnected");
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_iTeam");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return false; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_bAlive");
		return *reinterpret_cast<bool*>(this + offset + idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_iHealth");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_iAccountID");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return false; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_bValid");
		return *reinterpret_cast<bool*>(this + offset + idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_iUserID");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CPlayerResource", "m_iTotalScore");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CTFPlayerResource", "m_iPlayerLevel");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CTFPlayerResource", "m_iDamage");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CTFPlayerResource", "m_iPlayerClass");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	{
		if (!this) { return 0; }
		static auto offset = N::FindNetvar("CTFPlayerResource", "m_iMaxHealth");
		return *reinterpret_cast<int*>(this + offset + 4 * idx);
	}
	...
	int* GetStreaks(int idx)
	{
		...
		static auto offset = N::FindNetvar("CTFPlayerResource", "m_iStreaks");
		return reinterpret_cast<int*>(this + offset + 4 * idx);
	}
};

...
{
	static auto FN = S::KeyValues_LoadFromBuffer.address;
	return reinterpret_cast<int(__thiscall*)(KeyValues*, char const*, const char*, void*, const char*)>(FN)(this, resource_name, buffer, file_system, path_id);
}

void KeyValues::Initialize(char* name)
{
	static auto FN = S::KeyValues_Initialize.address - 0x42;
	reinterpret_cast<KeyValues* (__thiscall*)(KeyValues*, char*)>(FN)(this, name);
}
...
{
	return reinterpret_cast<KeyValues * (__thiscall*)(KeyValues*, const char*, bool)>(S::KeyValues_FindKey.address)(this, keyName, bCreate);
}
...
{
	static auto FN = reinterpret_cast<const char* (__thiscall*)(KeyValues*)>(S::KeyValues_GetName.address);
	return FN(this);
}

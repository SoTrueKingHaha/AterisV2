...
public:
	...
	virtual void LoadMatrix(view_matrix const& matrix) = 0;
	virtual void LoadMatrix(matrix3x4_t const& matrix) = 0;
	virtual void MultMatrix(view_matrix const& matrix) = 0;
	virtual void MultMatrix(matrix3x4_t const& matrix) = 0;
	virtual void MultMatrixLocal(view_matrix const& matrix) = 0;
	virtual void MultMatrixLocal(matrix3x4_t const& matrix) = 0;
	virtual void GetMatrix(MaterialMatrixMode_t matrixMode, view_matrix* matrix) = 0;
	...
	virtual bool GetMorphAccumulatorTexCoord(vector_2d* pTexCoord, IMorph* pMorph, int nVertex) = 0;

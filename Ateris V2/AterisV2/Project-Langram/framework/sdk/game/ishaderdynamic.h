...
public:
	...
	virtual const FlashlightState_t& GetFlashlightState(view_matrix& worldToTexture) const = 0;
	...
	virtual const FlashlightState_t& GetFlashlightStateEx(view_matrix& worldToTexture, ITexture** pFlashlightDepthTexture) const = 0;
   ...
   // known only at dynamic state time. It's here only to silence warnings.
	...
	virtual void ExecuteCommandBuffer(unsigned char* pCmdBuffer) = 0;

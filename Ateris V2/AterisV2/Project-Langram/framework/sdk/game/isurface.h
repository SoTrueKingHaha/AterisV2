...
public:
	...
	virtual void DrawPanelIn3DSpace(VPANEL pRootPanel, const view_matrix& panelCenterToWorld, int nPixelWidth, int nPixelHeight, float flWorldWidth, float flWorldHeight) = 0;
